...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PATIENT_EXT_DEATH_DATE_HX
...
| EXT_RPT_DEATH_DATE | DATETIME | Stores all previous externally reported values for a patient's date of death. |
