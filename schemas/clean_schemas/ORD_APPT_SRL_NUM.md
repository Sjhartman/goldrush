...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ORD_APPT_SRL_NUM

## Description

This table contains the appointment serial number of the appointments scheduled for an order.
...
| LINE | No | The line count for the appointment serial number. |
| APPTS_SCHEDULED | NUMERIC (18,0) | The appointment serial number for the appointments scheduled from this order.  This may point to multiple encounters in PAT_ENC if the appointment was rescheduled. |
...
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_ORD_APPT_SRL_NUM_001 | APPTS_SCHEDULED | 1 | Yes | Yes |  |
...
_(199 total; showing first 30)_
