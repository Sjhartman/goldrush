...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_UCN_CONVERT

## Description

Contains if the patient's notes are converted for UCN.
...
| --- | --- | --- |
| PAT_ENC_CSN_ID | NUMERIC (18,0) | The contact serial number (CSN) for this contact. This number is unique across all patient encounters in your system. If you use IntraConnect, this is the Unique Contact Identifier (UCI). |
...
| LINKED_UCN_NOTES_ID | VARCHAR (254) | Contains the IDs of the notes linked to this patient encounter. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PAT_UCN_CONVERT_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_PAT_UCN_CONVERT_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
...
_(180 total; showing first 30)_
