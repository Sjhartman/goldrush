...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=RESULT_VARIANT
...
| VARIANT_ID | NUMERIC (18,0) | A list of variant records associated with this result |
| VARIANT_RPT_YN | VARCHAR (1) |  |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_OVR_VARIANT | VARIANT_ID | 1 | Yes | Yes |  |
