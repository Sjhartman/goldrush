...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=OB_HSB_DEL_CMPLCTN
...
| OB_DEL_COMPLIC_ID | NUMERIC (18,0) | The unique ID of the diagnosis which is associated with a complication that arose during delivery. This column may be linked to DX_ID in table CLARITY_EDG to obtain more specific information about the diagnosis. |
