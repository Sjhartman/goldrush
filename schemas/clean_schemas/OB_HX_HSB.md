...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=OB_HX_HSB

## Description

The OB_HX_HSB table contains information about episodes (pregnancy and delivery record HSB records) linked to a patient's OB history.
...
| OB_HX_PREG_EPIS_ID | NUMERIC (18,0) | Stores a link to the pregnancy episode for OB history. |
| OB_HX_DEL_REC_ID | NUMERIC (18,0) | Stores a link to the delivery record for OB history. |
...
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_OB_HX_HSB_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_OB_HX_HSB_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
...
_(341 total; showing first 30)_
