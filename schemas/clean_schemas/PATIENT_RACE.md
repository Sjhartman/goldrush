...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PATIENT_RACE
...
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PATIENT_RACE_PARAC | PATIENT_RACE_C | 1 | Yes | Yes |  |
