...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ORDER_ATTRIBUTE
...
| LINE | No | The line number for the order attributes (I ORD 32). |
| ORD_ATTRIBUTE_C | INTEGER |  |
