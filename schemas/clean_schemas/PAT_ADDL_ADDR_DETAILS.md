# PAT_ADDL_ADDR_DETAILS

**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_ADDL_ADDR_DETAILS

## Description

Stores the patient's additional address details.
...
| ADDRESS_DETAILS_C | INTEGER |  |
| ADDRESS_DETAILS_VAL | VARCHAR (80) | Stores the additional address value corresponding to the type in the ADDRESS_DETAILS_C column. |
