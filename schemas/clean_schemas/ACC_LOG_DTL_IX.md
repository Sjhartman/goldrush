...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ACC_LOG_DTL_IX

## Description

The ACC_LOG_DTL_IX table contains the supplementary information of the activities which were recorded in the ACCESS_LOG table, such as pairs of mnemonics and their responding values for indexed items.
