...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_EPISODE
...
| EPISODE_ID | NUMERIC (18,0) | The unique ID number associated with an Episode of Care. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PAT_EPISODE_EPISODE_ID | EPISODE_ID | 1 | Yes | Yes |  |
