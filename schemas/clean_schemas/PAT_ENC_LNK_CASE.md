...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_ENC_LNK_CASE
...
| LINKED_CASE_ID | VARCHAR (184) | The surgical case ID that is linked to the encounter. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PAT_ENC_LNK_CASE_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_PAT_ENC_LNK_CASE_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
