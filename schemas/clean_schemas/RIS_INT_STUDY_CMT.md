...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=RIS_INT_STUDY_CMT
...
| LINE | No | The line number for interesting study comments associated with this record. Multiple pieces of information can be associated with this record. |
| INT_STUDY_COMMENT | VARCHAR (255) | Free text comments made by the physician for an interesting study. |
