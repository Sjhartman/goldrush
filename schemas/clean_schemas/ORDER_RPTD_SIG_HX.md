...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ORDER_RPTD_SIG_HX
...
| ENTRY_USER_ID | VARCHAR (18) | The unique identifier of the user who entered the medication instructions. |
| ENTRY_DTTM | DATETIME (Local) | The date and time when these medication instructions were entered. |
| ACTION_C | INTEGER |  |
| SOURCE_C | INTEGER |  |
| INFORMANT_C | INTEGER |  |
| REASON_C | INTEGER |  |
| REASON_COMMENT | VARCHAR (255) | Additional comments on the reason why the patient is not taking the medication as prescribed. |
| DOSE_MIN | NUMERIC (19,4) | The lower bound of the ranged dose for this medication's instructions. |
| DOSE_UNIT_C | INTEGER |  |
| FREQUENCY_ID | VARCHAR (18) | The unique identifier of the frequency record used in the medication instructions. |
| PRN_COMMENT | VARCHAR (450) | The as-needed comment for the medication instructions. |
| ROUTE_C | INTEGER |  |
| INDICATIONS_COMMENT | VARCHAR (300) | Comments about the indications of use for the medication instructions. |
| DOSE_MAX | NUMERIC (19,4) | The upper bound of the ranged dose for this medication's instructions. |
| USAGE_CODE_C | INTEGER |  |
| BRUKSOMRADE | VARCHAR (280) | Stores the patient-reported Bruksom?de in Norway |
| BRUKSOMRADE_MEDICAL_COND_ID | NUMERIC (18,0) | Stores the patient-reported Bruksom?de (Discrete) in Norway |
| RPTSIG_USES_TOD_IN_PAT_SIG_C | INTEGER |  |
| PT_TAKING_DIFF_CMTS | VARCHAR (255) | Stores taking differently comments entered by the patient during eCheck-in or Welcome self-arrival. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_RPTD_SIG_CSN | PAT_ENC_CSN_ID | 1 | Yes | Yes |  |
