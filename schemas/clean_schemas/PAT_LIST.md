...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_LIST
...
| --- | --- | --- |
| PAT_ID | VARCHAR (18) | Unique patient ID. |
| LINE | No | The line number within a multiple response or over time item |
| LIST_ID | VARCHAR (18) | The patient list associated with the patient ID. |
