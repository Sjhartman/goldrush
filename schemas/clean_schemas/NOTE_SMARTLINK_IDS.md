...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=NOTE_SMARTLINK_IDS

## Description

This table stores the SmartLink IDs used by the notes.
...
| SMARTLINKS_ID | NUMERIC (18,0) | This item stores the SmartLink used in the note. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_NOTE_SMARTLINK_IDS_CONTACT | NOTE_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_NOTE_SMARTLINK_IDS_CONTACT | CONTACT_DATE_REAL | 2 | Yes | Yes |  |
