...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PATIENT_TYPE
...
| --- | --- | --- |
| PAT_ID | VARCHAR (18) | The unique ID of the patient. This value is encrypted if encryption is enabled. |
| LINE | No | A patient can be defined with one or many types.  This is the line number corresponding to the type for each patient. |
| PATIENT_TYPE_C | VARCHAR (66) |  |
