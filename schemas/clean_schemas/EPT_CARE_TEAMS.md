...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=EPT_CARE_TEAMS
...
| CARE_TEAMS_ID | NUMERIC (18,0) | The unique ID of the Provider Care Team that is assigned to the patient encounter. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_EPT_OT_MULT_TEAM_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_EPT_OT_MULT_TEAM_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
