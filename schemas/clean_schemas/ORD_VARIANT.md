...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ORD_VARIANT
...
| VARIANT_ID | NUMERIC (18,0) | The unique ID of the variant record associated with the order |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_VARIANT | VARIANT_ID | 1 | Yes | Yes |  |
