...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PNEG_MED_HX
...
| PNEG_MED_HX_ID | NUMERIC (18,0) | The unique ID of the diagnosis record associated with a patient's pertinent negatives medical history. Note: This is NOT the ICD9 diagnosis code. It is an internal identifier that is typically not visible to a user. |
| PNEG_MED_HX_DT | DATETIME | The entry date for a patient's pertinent negative medical history for a diagnoses. |
| PNEG_MED_HX_CMT | VARCHAR (1000) | Free text comments entered for the diagnoses in a patient's pertinent negative medical history. |
| PNEG_MED_HX_ANNO | VARCHAR (254) | The annotation for the diagnoses in a patient's pertinent negative medical history. |
...
| PNEG_MED_HX_SRC_C | INTEGER |  |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PNEG_MED_HX_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_PNEG_MED_HX_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
