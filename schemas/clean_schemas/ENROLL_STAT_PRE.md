...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ENROLL_STAT_PRE

## Description

Table contains list of enrollment statuses considered to be "pre-enrolled".
