...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=VALID_PATIENT

## Description

The VALID_PATIENT table contains one row for each patient in your system and indicates whether the patient is considered valid for reporting purposes.
