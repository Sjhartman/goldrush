...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=TRTTEAM_AUDIT
...
| TT_USER_ID | VARCHAR (18) | The unique ID of the User that is associated with this treatment team audit trail line. |
| TT_EDIT_INSTANT | DATETIME (Local) | The instant the treatment team was edited. |
| TT_ACTION_C | INTEGER |  |
| TT_PROVIDER_ID | VARCHAR (18) | The unique ID of the Provider that is associated with this treatment team audit trail line. |
| TT_ROLE_C | VARCHAR (66) |  |
| TT_CARE_TEAM_ID | NUMERIC (18,0) | The unique ID of the User that is associated with this treatment team audit trail line. |
| TT_ED_PROV_YN | VARCHAR (1) |  |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_TRTTEAM_AUDIT_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_TRTTEAM_AUDIT_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
...
_(184 total; showing first 30)_
