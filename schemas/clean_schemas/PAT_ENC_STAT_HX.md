...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_ENC_STAT_HX
...
| UPDATE_USER_ID | VARCHAR (18) | User who updated the ADT encounter status. |
| UPDATE_TIME | DATETIME (Local) | Instant the encounter status was updated |
| UPDATED_ENC_STAT_C | INTEGER |  |
| UPDATED_CONF_STAT_C | INTEGER |  |
| UPDATE_REASON_EPT_C | INTEGER |  |
| UPDATE_REASON_ADT_C | VARCHAR (66) |  |
| UPDATE_EVENT_ID | NUMERIC (18,0) | The unique ID of the Leave of Absence Event that triggered the update to the encounter's status. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PAT_ENC_STAT_HX_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_PAT_ENC_STAT_HX_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
