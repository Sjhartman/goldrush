...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_ALLERGIES
...
| CM_PHY_OWNER_ID | VARCHAR (25) | The physical owner in a Care Everywhere system. |
| CM_LOG_OWNER_ID | VARCHAR (25) | The logical owner in a Care Everywhere system. |
| ALLERGY_RECORD_ID | NUMERIC (18,0) | This column contains the allergies that are associated with the patient. The allergies are stored as unique identifiers so they can be networked to the problem (LPL) master file. |
