...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ORDER_MED_VITALS
...
| WEIGHT_AT_RELEASE | NUMERIC (18,2) | The patient's recorded weight in kilograms at the time the order was released. |
| WEIGHT_REL_SOURCE_C | INTEGER |  |
| HEIGHT_AT_RELEASE | NUMERIC (18,2) | The patient's recorded height in centimeters at the time the order was released. |
| HEIGHT_REL_SOURCE_C | INTEGER |  |
| BSA_AT_RELEASE | NUMERIC (18,2) | The patient's calculated body surface area (BSA) in meters squared at the time the order was released. |
| BSA_REL_SOURCE_C | INTEGER |  |
