...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=EXTERNAL_DEATH_REPORTS
...
| EXT_DEATH_STAT_C | INTEGER |  |
| EXT_DEATH_DATE | DATETIME | Stores the reported date of death of a given external report on a patient's death. |
| EXT_DEATH_SOURCE_C | INTEGER |  |
| EXT_DEATH_COMMENT | VARCHAR (2000) | Stores an optional comment of a given external report on a patient's death. |
| EXT_DEATH_IER_RECORD_CSN_ID | NUMERIC (18,0) | The Event (IER) CSN that created this line of external mortality data. |
| EXT_DEATH_ORG_ID | NUMERIC (18,0) | This item holds the DXO ID of the external organization that has reported this deceased information. |
