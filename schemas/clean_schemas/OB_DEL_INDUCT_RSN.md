...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=OB_DEL_INDUCT_RSN
...
| --- | --- | --- |
| SUMMARY_BLOCK_ID | NUMERIC (18,0) | The unique identifier (.1 item) for the summary block record. The delivery record ID on which the data is stored. |
