...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=EXT_ORD_SIGNED_SUMMARY
...
| --- | --- | --- |
| ORDER_ID | NUMERIC (18,0) | The unique identifier (.1 item) for the order record for this row. |
...
| EXT_ORD_SIGNED_SUMMARY | VARCHAR (254) | The summary of this order. All lines of this order's summary should be concatenated to get the full summary text. |
