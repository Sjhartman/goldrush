...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_HX_REVIEW
...
| LINE_COUNT | No | The line number for the information associated with this record. Multiple pieces of information can be associated with this record. |
...
| HX_REVIEWED_USER_ID | VARCHAR (18) | The unique ID of the user who reviewed history for the patient. |
| HX_REVIEWED_DATE | DATETIME | The date history was reviewed for this patient. |
| HX_REVIEWED_INSTANT | DATETIME (Local) | The date and time history was reviewed for this patient. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PAT_HX_REVIEW_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_PAT_HX_REVIEW_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
...
_(168 total; showing first 30)_
