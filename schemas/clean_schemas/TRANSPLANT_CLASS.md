...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=TRANSPLANT_CLASS
...
| --- | --- | --- |
| SUMMARY_BLOCK_ID | NUMERIC (18,0) | The transplant episode record ID. |
...
| TX_CLASS_C | INTEGER |  |
| TX_ACTIVE_COORD_ID | VARCHAR (18) | The unique ID of the provider who is listed as a current active coordinator for the transplant. |
