...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ORGANISM_LIST
...
| ORGANISM_LIST_ID | NUMERIC (18,0) | Compiled list of organisms for the most recent results. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_ORD_ORGANISM_LIST_ORD_ORG | ORGANISM_LIST_ID | 1 | Yes | Yes |  |
