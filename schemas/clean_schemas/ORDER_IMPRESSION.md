...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=ORDER_IMPRESSION
...
| LINE | No | The line count for the reading physician's impression. |
| CM_CT_OWNER_ID | VARCHAR (25) | The contact owner deployment of this record, used in Care Everywhere record sharing. |
| IMPRESSION | VARCHAR (1000) | The reading physician's impression for this procedure. |
