...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=STAND_HOV_INST_ORD
...
| --- | --- | --- |
| ORDER_ID | NUMERIC (18,0) | The unique ID of the order record. This is the ?grandparent? order record. |
...
| STAND_INS_IP_ORD_ID | NUMERIC (18,0) | The unique ID of the instantiated hospital outpatient visit child orders (i.e. the ?parent? order in the grandparent/parent/child structure). Note that the order in this column may also be found in ORDER_INSTANTIATED.ORDER_ID (assuming that child orders have been released from this order). |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_STAND_HOV_INST_ORD_INS_ID | STAND_INS_IP_ORD_ID | 1 | Yes | Yes |  |
