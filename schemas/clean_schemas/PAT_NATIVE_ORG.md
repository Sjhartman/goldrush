...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_NATIVE_ORG
...
| CM_LOG_OWNER_ID | VARCHAR (25) | ID of the logical deployment owner for this record. Logical owners show the deployment where the record was created but doesn't show if the record is a part of version skew. |
| ORG_RECORD_ID | NUMERIC (18,0) | List of native organ records for the patient |
