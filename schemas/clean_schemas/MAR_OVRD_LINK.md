...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=MAR_OVRD_LINK

## Description

This table contains the order IDs for medications that are connected through override pull linking.
...
| OVRD_LNK_ORDER_ID | NUMERIC (18,0) | The unique ID of the linked medication order. |
