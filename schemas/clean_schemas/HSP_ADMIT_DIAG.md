...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=HSP_ADMIT_DIAG
...
| --- | --- | --- |
| PAT_ID | VARCHAR (18) | The ID of the patient with this admission diagnosis. |
...
| LINE | No | The line number of the admission diagnosis for the patient. |
| DX_ID | NUMERIC (18,0) | Unique Identifier for diagnosis record used to document patient's admission diagnosis. |
| ADMIT_DIAG_TEXT | VARCHAR (255) | Free text admission diagnosis for the patient. |
...
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_HSP_ADMIT_DIAGENC | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_HSP_ADMIT_DIAGENC | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
| B-TREE INDEX | EIX_HSP_ADMIT_DIAG_DX_CSN | DX_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_HSP_ADMIT_DIAG_DX_CSN | PAT_ENC_CSN_ID | 2 | Yes | Yes |  |
