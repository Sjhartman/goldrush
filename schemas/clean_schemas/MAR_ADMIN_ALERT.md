...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=MAR_ADMIN_ALERT
...
| MAR_ALERT_ID | NUMERIC (18,0) | The Alert ID of the alert seen during this medication administration. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_MARADMINALT_MAR_ALT_ID | MAR_ALERT_ID | 1 | Yes | Yes |  |
