...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=MPI_CSID_NUM
...
| MPI_CSID | VARCHAR (184) | To determine which patient owned which contact within a merged record |
| MPI_CSID_TYPE_ID | NUMERIC (18,0) | To easily determine which contact owns which merged record |
| MPI_START_UTC_DTTM | DATETIME (UTC) | The start date and time for a contact specific identity. |
| MPI_END_UTC_DTTM | DATETIME (UTC) | The end date and time for a contact specific identity. |
| MPI_CSID_AIP_ID | VARCHAR (93) | The inferface specification record used to configure the interface associated with this contact specific identity. |
| MPI_CSID_CHANGE_LINE | INTEGER | The line in the Cadence change appointment audit array (I EPT 7870) associated with a given identifier for an appointment. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_MPI_CSID_NUM_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_MPI_CSID_NUM_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
...
_(156 total; showing first 30)_
