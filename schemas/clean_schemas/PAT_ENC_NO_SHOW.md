...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_ENC_NO_SHOW
...
| NO_SHOW_ACTION_C | VARCHAR (66) |  |
| NO_SHOW_OUTCOME_C | VARCHAR (66) |  |
| NO_SHOW_COMMENT | VARCHAR (500) | The no show comments entered by the user. |
| NO_SHOW_USER_ID | VARCHAR (18) | The unique ID associated with the user record for this row. This column is frequently used to link to the CLARITY_EMP table. |
| NO_SHOW_ACTION_DATE | DATETIME | Date of the no show action. |
| NO_SHOW_ACTION_TIME | DATETIME (Local) | Time of the no show action. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_NO_SHOW_DOC_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_NO_SHOW_DOC_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
