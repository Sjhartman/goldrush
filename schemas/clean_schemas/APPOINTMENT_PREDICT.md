...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=APPOINTMENT_PREDICT

## Description

This table contains information about the predicted no show likelihood for appointments.
...
| PROBABILITY_PERCENT | NUMERIC (18,3) | This column stores the probability that the appointment will be a No Show based on the No Show predictive model. Each time the appointment is evaluated, the result will be stored as a new line. |
| EVALUATION_UTC_DTTM | DATETIME (UTC) | This column stores the UTC datetime that the appointment was evaluated against the No Show predictive model. |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_APPOINTME258473653_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_APPOINTME258473653_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
