...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=MAR_FSD_LINK_LINE

## Description

This table contains the line counts for the linked administrations that are connected through override pull linking.
...
| MAR_FLO_FSD_LINE | INTEGER | The line in FSD where the flowsheet data is stored that is linked to this administration. |
