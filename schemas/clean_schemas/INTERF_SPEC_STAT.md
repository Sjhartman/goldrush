...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=INTERF_SPEC_STAT

## Description

This table displays the interface status for a given order.
...
| INTERF_ID | NUMERIC (18,0) | Interface (AIP) processing this order. |
| INTERF_SPEC_STAT_C | INTEGER |  |
| VERIFY_STATUS_C | INTEGER |  |
| STATUS_DTTM | DATETIME (Local) | Date and time at which the interface in INTERF_ID has processed the order in ORDER_ID. |
