...
**Source:** https://datahandbook.epic.com/ClarityDictionary/Details?tblName=PAT_ENC_AMBIENT_SESSIONS
...
| AMBIENT_SESSION_IDENT | VARCHAR (64) | Session IDs for Ambient Recordings. Points to DXR |
| DEVICE_LOCAL_IDENT | VARCHAR (40) | Identifies the session material on the remote device where the session was created if and only if the session was created without a connection to the server in offline mode. |
| CREATE_DEVICE_IDENT | VARCHAR (40) |  |

## Indexes

| Type | Name | Column Name | Ordinal Position | Enabled | Key Column |  |
| --- | --- | --- | --- | --- | --- | --- |
| B-TREE INDEX | EIX_PAT_AMB_SESSIONS_CONTACT | PAT_ID | 1 | Yes | Yes |  |
| B-TREE INDEX | EIX_PAT_AMB_SESSIONS_CONTACT | PAT_ENC_DATE_REAL | 2 | Yes | Yes |  |
